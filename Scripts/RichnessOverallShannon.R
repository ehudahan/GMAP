...
g <- ggplot(data, color="gray", aes(x = sampleTimeLabels , y = shannon #, fill = sampleTimeLabels
                      )) + 
...
{
    path <- "Figures/"
    fileName <- "RichnessOverallShannon"
    if (0) {
