...
# data
{
  ...
  try(setwd("/sci/labs/morani/morani/icore-data/lab/Projects/GMAP/Docs/GMAP_Paper/"), silent = T)
  getwd()
...
if (1){
  tab %>% as_gt() %>% gt::gtsave(filename = "Figures/Microbiome_revision/PDFs/DemographicTable.pdf", zoom = 1)
