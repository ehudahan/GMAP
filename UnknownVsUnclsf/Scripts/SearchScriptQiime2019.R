...
if(1){
  rm(list=ls())
  try(setwd("~/GMAP/QIIME2/RunQiime2As2019/output"), silent = T)
  try(setwd("/Volumes/ehudda/GMAP/QIIME2/RunQiime2As2019/output"), silent = T)
  try(setwd("/vol/sci/bio/data/moran.yassour/lab/Projects/GMAP/QIIME2/RunQiime2As2019/output"), silent = T)
  getwd()
