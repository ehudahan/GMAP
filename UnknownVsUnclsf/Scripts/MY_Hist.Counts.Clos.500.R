...
if(1){
  ...
  getwd()
  tab <- read.delim("top.clos.unkwn.uncls.blast.out", header = F)
...
hist_tab(tab.clos, "Bacs.Count.clos.500", paste0(bac," (num of reads > 500)"))
...
hist_tab(tab.clos.NOT.uncultured, "Bacs.Count.clos.500.WO.uncultured", paste0(bac," (num of reads > 500)"))
